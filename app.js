const express = require('express'); // the waiter--allows you to connect to route
const session = require('express-session'); //things that run as long as the server is running
